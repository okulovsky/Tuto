...
namespace Tuto.Navigator
{
    ...
    public class OutlinedTextBlock : FrameworkElement, INotifyPropertyChanged
    {
        ...
        public string Text
        {
            ...
            set { SetValue(TextProperty, value); if (PropertyChanged != null) PropertyChanged(this, new PropertyChangedEventArgs("Text"));}
        }
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            if (finalSize.Height == 0)
                this.formattedText.MaxTextHeight = 200;
            else
        ...
        private static void OnFormattedTextInvalidated(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (outlinedTextBlock.formattedText == null)
            {
                return;
            }
